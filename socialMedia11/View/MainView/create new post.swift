...
struct create_new_post: View {
    ...
    var body: some View{
            ...
            Task {
                do {
                    ...
                    if let postImageData = postImageData {
                        ...
                        let post = Post(text: postText, userName: userName, userUID: userUID, userProfIleURL: profileURL, imageId: imageRefrenceId, imageURL: downloadURL.absoluteString)
        ...
        // Separate function for triggering CreatePost
        func triggerCreatePost() {
            CreatePost()
        }
